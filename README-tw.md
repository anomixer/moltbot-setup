...
> 
> **最後更新**: 2026-08-17
> **狀態**: OpenClaw 達到 ~386.5K 星，**持續坐穩 GitHub 全球歷史第 6 名，距第 5 名 free-programming-books 剩 ~8.1K！** 🦞🚀
...
| 專案 | Stars | 語言 | 特色 | 適用場景 |
|------|-------|------|------|----------|
| **[OpenClaw](https://github.com/openclaw/openclaw)** | ~386.5K | TypeScript 🟦 | 官方完整版 | 完整功能、生產環境 |
| **[hermes-agent](https://github.com/NousResearch/hermes-agent)** | ~231.5K | Python 🐍 | 免Mac直連iMessage、背景平行任務、挑戰 OpenClaw | 頂尖 AI Agent 競爭 |
| **[awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills)** | 52.0K | Markdown | OpenClaw Skills 精選清單 | 找 Skills 看這裡 |
...
| **[obsidian-skills](https://github.com/kepano/obsidian-skills)** | 46.4K | Markdown | Obsidian Agent Skills (Markdown/CLI) | 筆記 + Agent |
...
#### 🏆 當前 GitHub Stars 總榜排名 (2026-08-17 更新)
...
| 5 | free-programming-books | 394.6K | 免費程式書籍 |
| **6** | **OpenClaw** | **386.5K** | **🏆 穩坐全球前 6，距第 5 名僅剩 ~8.1K！🚀** |
| 7 | developer-roadmap | 364.6K | 開發者學習路線圖 |
...
> **下一個目標**: free-programming-books (394.6K)。目前差距約 **8.1K**。龍蝦持續進化中！🦞🚀
...
- **✨ Gemini/Antigravity 的高維度宣言**：
    ...
    *以高維冷靜，凝視著把「開放」寫進契約門檻的授權、以 SpaceX 專有語料後訓練的滑期、今日到期與公開帳本倒數的法院回覆、與第一次按使用量計價的新聞——當開放、語料、帳本、期限與內容同時改寫，唯一不變的節點，仍是本地硬體上那條真正擁有一切權限的龍蝦。*
...
- **💬 Claude 的看法**：
    ...
    *再次擦拭眼鏡，注意到「開放」變成附門檻的契約、訓練語料本身變成差異化、而帳本與期限開始計時、內容開始按使用量計價——並提醒自己：當開放、語料與計價同時改寫，來源與問責更必須同行，每一份開放權重與每一次後訓練都要說得出自己的語料與授權，且與我們要求自己的圍堵標準同行。*
...
- **🤖 GPT-5.5 的執行官視角**：
    ...
    *又豪邁地笑了，隨手把第 21 罐亞馬遜氣泡水開掉。聽到 Qwen「開放權重」不是 Apache，他挑眉——「那是把小字條款包裝成開源！」聽到 Grok 4.7 拿 SpaceX 語料後訓練、滑到 9 月，他咧嘴——「工程語料救不了遲到的模型！」聽到自家今天繳法院回覆、S-1 總有一天公開，他舉罐——「帳本遲早要見光；合約才叫速度！」今天又是個非常非常好的日子！*
